...
<html lang="en">
    <head>
     ...
     <body class="page-body  page-left-in" data-url="http://neon.dev">
        <div id="tooltip"></div>
        <div class="analystclassforvariate" id="anlsytpage"></div>
        <?php
          $analystid = Session::get('analyst_id');
         ?>       
       <?php
        $client_names=[];
...
$prevmonth=Date('F', strtotime($currentMonth . " last month"));
        ...
        ?>
        <?php $clientunanalyst=DB::table('analyst_client')->where('analyst_id',$analystid)->get();
      foreach ($clientunanalyst as $key => $value){
     $clients=DB::table('users')->where('id',$value->client_id)->get();  
     array_push($client_names,$clients);   
    }
            ...
            <div class="sidebar-menu">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li style="cursor:pointer;">
                            <span id="logoutdropdown" role="button" data-toggle="dropdown" data-target="#" class=""> 
                               Welcome Analyst  <i class="caret"></i>
                ...
                <ul id="main-menu" class="">
                    ...
                    <!-- Search Bar -->
                      ...
                      <li id="upload_report_analyst">
                        <a href="javascript:void(0);">
                         <i class="entypo-bag"></i>
                        <span>Upload Report</span></a>
 ...
 <li id={{$f[0]->id}} class="report_names"> 
									
                
    <a href="javascript:void(0);">
   <i class="entypo-bag"></i>
  <span>{{$r}}</span></a>
 <ul class=keyvalue_report{{$f[0]->id}}>
    ...
    @else
        <?php if($r == "Home State Of Play"){
            $id=$f[0]->id;
           echo "<li id=$id class='report_names home_report'>"; 
        }else if($r == "Executive Summary"){
             
            echo "<li id=$id class='report_names executive_report'>"; 
        }
...
<?php echo "<a href=javascript:void(0);>"; ?>
 ...
 <!-- -----------------------upload report by analyst----------------------------- -->
           
     <div class="main-content uploadreport_by_analyst" style="display:none;">
    <div class="row">
                ...
                <div class="panel-body">
                     ...
                     <form role="form" class="form-horizontal form-groups-bordered" id="upload_form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select class="col-sm-12" style="min-height: 30px;" id="client" name="id">
                                    <option value="">Select Client</option>
                                    @forelse($client_names as $f)
                                    <option value="{{$f[0]->id}}">{{$f[0]->name}}</option>
                                    @empty
                                    ...
                                    <div class="chart-nav-tabs">
                                        ...
                                        <div class="tab-content">
                                            <div class="row">
                                                ...
                                                <button  class="btn btn-info btn-xs change_report_btn">change report</button>
                                                    </div>
...
<!-- -------------------------------------------------------------------------- --> 
        ...
        <script src={{ asset('/js/app/analyst_home.js') }}></script>
