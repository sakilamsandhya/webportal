            ...
            <div class="login-box-body">
             <div id="change"></div>
                <p class="login-box-msg">Change Password</p>
                     <hr>
                <form method="post" id="changepassword_form" role="form">
                    <div class="form-group">
                                           <input type="email" name="change_email" id="change_email" placeholder="Email" class="form-control">
                    </div>  
            <div class="form-group">
                            <input type="password" name="old_password" id="choldpwd" placeholder="Old Password" class="form-control">
                    </div>
             <div class="form-group">
                            <input type="password" name="change_password" id="chpwd" placeholder="New Password" class="form-control">
                    </div>
            <div class="form-group">
            
                <input type="password" name="change_confirm_password" placeholder="Confirm Password" id="chcpwd" class="form-control">
                    </div><hr>
                    <div class="form-group col-lg-5 col-lg-offset-8">
                        
             <button type="submit" class="btn btn-primary btn-block" id="contact-submit">ChangePassword</button>
                    </div>
